...
export default function StaffStatCards({ staffMembers }: { staffMembers: any[] }) {
    // Calculate stats
    const totalMonthlyPayroll = staffMembers.reduce((sum, s) => sum + (s.grossSalary || 0), 0);
    ...
    return (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 md:gap-4">
            ...
            <div className="bg-card p-3 md:p-5 rounded-2xl md:rounded-[1.5rem] border border-border shadow-sm">
                ...
                <div className="hidden md:block font-ubuntu text-xs text-text-muted mt-2">Monthly Payroll</div>
            </div>
